...
var Validation = function Validation(ComposedComponent) {
  return (function (_ComposedComponent) {
    ...
    function ValidationComponent(props, context) {
      var _this = this;

      _classCallCheck(this, ValidationComponent);

      _get(Object.getPrototypeOf(ValidationComponent.prototype), 'constructor', this).call(this, props, context);

      this.validate = function (path, callback) {
        var validationValue = (0, _lodashClonedeep2['default'])((0, _lodashResult2['default'])(_this, 'validationValue', _this.state));
      ...
      this.isValid = function (path) {
        ...
        if (path) {
          errors = (0, _lodashFilter2['default'])(errors, function (error) {
            return error.path === path || (0, _lodashStartswith2['default'])(error.path, path + '.');
          });
        }
      ...
      this.getValidationValue = function () {
        return (0, _lodashClonedeep2['default'])(_objectPath2['default'].get(_this.state, 'validation.value'));
      };

      this.resetValidation = function (callback) {
        if (callback) {
          _this.setState({
            validation: {
              dirty: [],
